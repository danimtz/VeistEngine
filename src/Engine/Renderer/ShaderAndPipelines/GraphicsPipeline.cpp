...
std::shared_ptr<GraphicsPipeline> GraphicsPipeline::Create(std::string shader_name, const VertexDescription& vertex_description)
{
	...
	return std::make_shared<VulkanGraphicsPipeline>(shader_name, vertex_description);
