...
namespace AssetLoader {
	...
	std::shared_ptr<SkyboxMaterial> loadSkyboxMaterialFromFilepath(const char* material_name, std::string filepath, const VertexDescription& vertex_desc); //TODO: dont like the VertexDescription argument dependency
