...
namespace Veist
{
	...
	Descriptor::Descriptor(VkDescriptorType type, const ShaderBuffer* buffer, uint32_t range, VkShaderStageFlags stage_flag) : m_type(type), m_stage_flag(stage_flag)
	{
