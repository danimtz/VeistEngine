...
//Renderpass recording functions
	...
	void bindMaterialData(Material& material);
	...
	void bindDescriptorSet(const DescriptorSet& descriptor_set, bool material_data = false, uint32_t offset_count = 0, uint32_t* p_dynamic_offset = nullptr);
...
private:
	...
	MaterialType* m_current_mat_type{ nullptr };
